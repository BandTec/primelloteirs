...
public class KPRunnin extends TelegramLongPollingBot {
	...
	public void onUpdateReceived(Update update) {
		...
		case "/dadospc":
			...
			mensagem2.setText("Espaço do HD: " + objHardware.getEspacoHd());
        ...
        case "/documento": 
            ...
            sendDocument.setDocument(new File("./logs/10-06-2020.log"));
        ...
        case "/estadomaquina":
        	...
        	mensagem2.setText("Memória atualmente: " + monitoramento.memoriaEmUso());
